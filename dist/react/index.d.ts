...
export { PaperType, PaperTypeNames, ConnectionStatus, } from 'detonger-web-bt';
export type { PrinterConfig, TextPrintOptions, ImagePrintOptions, PrintStats, PrinterStatus, PrinterPrintStats, ErrorCallback, StatusChangeCallback, } from '../index';
